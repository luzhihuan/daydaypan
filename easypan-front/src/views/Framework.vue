        ...
        <el-dropdown>
          <div class="user-info">
            <div class="avatar-container">
              <Avatar :userId="userInfo.userId" :avatar="userInfo.avatar" :timestamp="timestamp" :width="46"
                      :role="userInfo.role">
              </Avatar>
            </div>
            <!-- 名称和标签 -->
    ...
    <div class="body">
      ...
      <div class="body-content">
        <router-view v-slot="{ Component }">
          <component :is="Component" @addFile="addFile" ref="routerViewRef" @reload="getUseSpace"></component>
        </router-view>
      </div>
    </div>
...
.body {
  ...
  .left-sider {
    ...
    .menu-list {
      ...
      width: 80px;
      box-shadow: 0 30px 10px 0 rgb(0 0 0 / 6%);
      border-right: 1px solid #f1f2f4;
